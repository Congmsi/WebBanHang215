...
namespace WebBanHang215.Migrations
{
    ...
    [Migration("20250606022645_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebBanHang215.Models.ChiTietNhapKho", b =>
                {
                    b.Property<string>("MaChiTietNk")
                        .HasMaxLength(30)
            ...
            modelBuilder.Entity("WebBanHang215.Models.NhapKho", b =>
                {
                    b.Property<string>("MaPhieuNhap")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("WebBanHang215.Models.ChiTietNhapKho", b =>
                {
                    b.HasOne("WebBanHang215.Models.NhapKho", "NhapKho")
                        .WithMany("ChiTietNhapKhos")
                        .HasForeignKey("MaPhieuNhap")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebBanHang215.Models.SanPham", "SanPham")
                        .WithMany("ChiTietNhapKhos")
                        .HasForeignKey("MaSp")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebBanHang215.Models.NhapKho", b =>
                {
                    b.HasOne("WebBanHang215.Models.NhaCungCap", "NhaCungCap")
                        .WithMany()
                        .HasForeignKey("MaNcc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
